...
class ImagesControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Images::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'image[imagen]' => 'Testing',
            'image[Titulo]' => 'Testing',
        ]);

        self::assertResponseRedirects('/images/');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'image[imagen]' => 'Something New',
            'image[Titulo]' => 'Something New',
        ]);
